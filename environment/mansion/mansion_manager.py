...
from liftsim.environment.mansion.elevator import Elevator
from liftsim.environment.mansion.utils import PersonType
from liftsim.environment.mansion.utils import MansionAttribute, MansionState, ElevatorState
from liftsim.environment.mansion.utils import EPSILON, ENTERING_TIME
from liftsim.environment.mansion.mansion_config import MansionConfig
from liftsim.environment.mansion.person_generators.generator_proxy import PersonGenerator
from liftsim.environment.mansion.person_generators.person_generator import PersonGeneratorBase
...
class MansionManager(object):
    ...
    def run_mansion(self, actions):
        ...
        #generate person and compute cost1
