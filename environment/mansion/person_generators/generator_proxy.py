...
from liftsim.environment.mansion.person_generators.uniform_generator import UniformPersonGenerator
from liftsim.environment.mansion.person_generators.custom_generator import CustomGenerator
